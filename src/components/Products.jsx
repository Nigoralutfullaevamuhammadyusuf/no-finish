...
const Products = () => {
    ...
    let componentMounted=true;
     ...
     const Loading=()=>{
        ...
        <button className='btn btn-outline-dark me-2' onClick={()=>filterProduct("men's clothing")}>Boys' clothes</button>
        <button className='btn btn-outline-dark me-2' onClick={()=>filterProduct("women's clothing")}>Girls' clothes</button>
